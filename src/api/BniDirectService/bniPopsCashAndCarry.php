...
trait bniPopsCashAndCarryService
{
    ...
    public function bniPopsCashAndCarry(
        ...
        $url = $this->bni->getBaseUrl() . Constant::URL_BNI_DIRECT_BNI_POPS_CASH_AND_CARRY;
        $data = [
