...
trait transferRTGS
{
     ...
     * @param string $transactionInstructionDate Transaction Instruction Date (max 8 chars, yyyyMMdd format) - required
    ...
    public function transferRTGS(
        ...
        $url = $this->bni->getBaseUrl() . Constant::URL_BNI_DIRECT_TRANSFER_RTGS;
        $data = [
